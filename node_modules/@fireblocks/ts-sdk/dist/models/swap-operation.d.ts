...
export declare const SwapOperationStatusEnum: {
    readonly Created: "CREATED";
    readonly TransactionInProgress: "TRANSACTION_IN_PROGRESS";
    readonly PendingProviderAction: "PENDING_PROVIDER_ACTION";
