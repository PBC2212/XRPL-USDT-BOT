...
jest.mock('../api', function () {
    ...
    return __assign(__assign({}, actual), { ApiUserApi: mockApiUserApi, AssetsApi: mockAssetsApi, AuditLogsApi: mockAuditLogsApi, BlockchainsAssetsApi: mockBlockchainsAssetsApi, ComplianceApi: mockComplianceApi, ComplianceScreeningConfigurationApi: mockComplianceScreeningConfigurationApi, ConsoleUserApi: mockConsoleUserApi, ContractInteractionsApi: mockContractInteractionsApi, ContractTemplatesApi: mockContractTemplatesApi, ContractsApi: mockContractsApi, CosignersBetaApi: mockCosignersBetaApi, DeployedContractsApi: mockDeployedContractsApi, EmbeddedWalletsApi: mockEmbeddedWalletsApi, ExchangeAccountsApi: mockExchangeAccountsApi, ExternalWalletsApi: mockExternalWalletsApi, FiatAccountsApi: mockFiatAccountsApi, GasStationsApi: mockGasStationsApi, InternalWalletsApi: mockInternalWalletsApi, JobManagementApi: mockJobManagementApi, KeyLinkBetaApi: mockKeyLinkBetaApi, KeysBetaApi: mockKeysBetaApi, NFTsApi: mockNFTsApi, NetworkConnectionsApi: mockNetworkConnectionsApi, OTABetaApi: mockOTABetaApi, OffExchangesApi: mockOffExchangesApi, PaymentsPayoutApi: mockPaymentsPayoutApi, PolicyEditorBetaApi: mockPolicyEditorBetaApi, ResetDeviceApi: mockResetDeviceApi, SmartTransferApi: mockSmartTransferApi, StakingApi: mockStakingApi, SwapBetaApi: mockSwapBetaApi, TagsApi: mockTagsApi, TokenizationApi: mockTokenizationApi, TransactionsApi: mockTransactionsApi, TravelRuleApi: mockTravelRuleApi, UserGroupsBetaApi: mockUserGroupsBetaApi, UsersApi: mockUsersApi, VaultsApi: mockVaultsApi, Web3ConnectionsApi: mockWeb3ConnectionsApi, WebhooksApi: mockWebhooksApi, WebhooksV2BetaApi: mockWebhooksV2BetaApi, WhitelistIpAddressesApi: mockWhitelistIpAddressesApi, WorkspaceStatusBetaApi: mockWorkspaceStatusBetaApi });
});
var mockedResponse = {
    data: 'Mocked data',
    status: 200,
...
describe("Fireblocks Client Tests", function () {
    ...
    describe('Api getters tests', function () {
        ...
        it('Should return EmbeddedWalletsApi', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(fireblocks.embeddedWallets).toBeInstanceOf(api_1.EmbeddedWalletsApi);
        ...
        it('Should return KeysBetaApi', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(fireblocks.keysBeta).toBeInstanceOf(api_1.KeysBetaApi);
        ...
        it('Should return StakingApi', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(fireblocks.staking).toBeInstanceOf(api_1.StakingApi);
                expect(mockStakingApi).toHaveBeenCalledWith(expectedConfig, undefined, mockAxios);
                return [2 /*return*/];
            });
        }); });
        it('Should return SwapBetaApi', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(fireblocks.swapBeta).toBeInstanceOf(api_1.SwapBetaApi);
                expect(mockSwapBetaApi).toHaveBeenCalledWith(expectedConfig, undefined, mockAxios);
                return [2 /*return*/];
            });
        }); });
        it('Should return TagsApi', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(fireblocks.tags).toBeInstanceOf(api_1.TagsApi);
        ...
        it('Should return TravelRuleApi', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(fireblocks.travelRule).toBeInstanceOf(api_1.TravelRuleApi);
        ...
        it('Should return WebhooksV2BetaApi', function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                expect(fireblocks.webhooksV2Beta).toBeInstanceOf(api_1.WebhooksV2BetaApi);
