...
exports.SplitChainDescriptorEnum = exports.MergeStakeAccountsChainDescriptorEnum = exports.ClaimRewardsChainDescriptorEnum = exports.StakingApi = exports.StakingApiFactory = exports.StakingApiFp = exports.StakingApiAxiosParamCreator = void 0;
...
var StakingApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        mergeStakeAccounts: function (mergeStakeAccountsRequest, chainDescriptor, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, common_1.assertParamExists)('mergeStakeAccounts', 'mergeStakeAccountsRequest', mergeStakeAccountsRequest);
                    (0, validation_utils_1.assertParamExistsAndNotEmpty)('mergeStakeAccounts', 'chainDescriptor', chainDescriptor);
                    localVarPath = "/staking/chains/{chainDescriptor}/merge"
                        .replace("{".concat("chainDescriptor", "}"), encodeURIComponent(String(chainDescriptor)));
                    localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
                    ...
                    headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                    localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(mergeStakeAccountsRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
                            url: (0, common_1.toPathString)(localVarUrlObj),
                            options: localVarRequestOptions,
                        }];
    ...
    return {
        ...
        mergeStakeAccounts: function (mergeStakeAccountsRequest, chainDescriptor, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.mergeStakeAccounts(mergeStakeAccountsRequest, chainDescriptor, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['StakingApi.mergeStakeAccounts']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
...
var StakingApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        mergeStakeAccounts: function (requestParameters, options) {
            return localVarFp.mergeStakeAccounts(requestParameters.mergeStakeAccountsRequest, requestParameters.chainDescriptor, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Perform a Solana Split stake account.
         * @summary Execute a Split operation on SOL/SOL_TEST stake account
...
var StakingApi = /** @class */ (function (_super) {
     ...
     * @memberof StakingApi
     */
    StakingApi.prototype.mergeStakeAccounts = function (requestParameters) {
        var _this = this;
        return (0, exports.StakingApiFp)(this.configuration).mergeStakeAccounts(requestParameters.mergeStakeAccountsRequest, requestParameters.chainDescriptor, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Perform a Solana Split stake account.
     * @summary Execute a Split operation on SOL/SOL_TEST stake account
 ...
 * @export
 */
exports.MergeStakeAccountsChainDescriptorEnum = {
    Sol: 'SOL',
    SolTest: 'SOL_TEST'
};
/**
