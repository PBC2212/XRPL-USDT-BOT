...
export declare const StakingApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    mergeStakeAccounts: (mergeStakeAccountsRequest: MergeStakeAccountsRequest, chainDescriptor: MergeStakeAccountsChainDescriptorEnum, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const StakingApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    mergeStakeAccounts(mergeStakeAccountsRequest: MergeStakeAccountsRequest, chainDescriptor: MergeStakeAccountsChainDescriptorEnum, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MergeStakeAccountsResponse>>;
    /**
     * Perform a Solana Split stake account.
     * @summary Execute a Split operation on SOL/SOL_TEST stake account
     * @param {SplitRequest} splitRequest
...
export declare class StakingApi extends BaseAPI {
     ...
     * @memberof StakingApi
     */
    mergeStakeAccounts(requestParameters: StakingApiMergeStakeAccountsRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<MergeStakeAccountsResponse>>;
    /**
     * Perform a Solana Split stake account.
     * @summary Execute a Split operation on SOL/SOL_TEST stake account
     * @param {StakingApiSplitRequest} requestParameters Request parameters.
 ...
 * @export
 */
export declare const MergeStakeAccountsChainDescriptorEnum: {
    readonly Sol: "SOL";
    readonly SolTest: "SOL_TEST";
};
