...
export declare const BlockchainsAssetsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getAsset: (id: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getBlockchain: (id: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listAssets: (blockchainId?: string, assetClass?: AssetClass, symbol?: string, scope?: AssetScope, deprecated?: boolean, ids?: Array<string>, pageCursor?: string, pageSize?: number, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    listBlockchains: (protocol?: string, deprecated?: boolean, test?: boolean, ids?: Array<string>, pageCursor?: string, pageSize?: number, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    updateAssetUserMetadata: (id: string, updateAssetUserMetadataRequest?: UpdateAssetUserMetadataRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const BlockchainsAssetsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getAsset(id: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Asset>>;
    /**
     * Returns an blockchain by ID or legacyID.
     * @summary Get an blockchain
     * @param {string} id The ID or legacyId of the blockchain
     ...
     * @throws {RequiredError}
     */
    getBlockchain(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<BlockchainResponse>>;
    /**
     * Legacy Endpoint – Retrieves all assets supported by Fireblocks in your workspace without extended information.</br> **Note**:    - This endpoint will remain available for the foreseeable future and is not deprecated.</br>   - The `listAssets` endpoint provides more detailed asset information and improved performance.</br>   - We recommend transitioning to the `listAssets` endpoint for better results.
     * @summary List all asset types supported by Fireblocks - legacy endpoint
     * @param {*} [options] Override http request option.
     ...
     * @throws {RequiredError}
     */
    listAssets(blockchainId?: string, assetClass?: AssetClass, symbol?: string, scope?: AssetScope, deprecated?: boolean, ids?: Array<string>, pageCursor?: string, pageSize?: number, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListAssetsResponse>>;
    /**
     * Returns all blockchains supported by Fireblocks.
     * @summary List blockchains
     * @param {string} [protocol] Blockchain protocol
     ...
     * @throws {RequiredError}
     */
    listBlockchains(protocol?: string, deprecated?: boolean, test?: boolean, ids?: Array<string>, pageCursor?: string, pageSize?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListBlockchainsResponse>>;
    /**
     * Register a new asset to a workspace and return the newly created asset\'s details. Currently supported chains are: - EVM based chains - Stellar - Algorand - TRON - NEAR - Solana
     * @summary Register an asset
     * @param {RegisterNewAssetRequest} [registerNewAssetRequest]
     ...
     * @throws {RequiredError}
     */
    updateAssetUserMetadata(id: string, updateAssetUserMetadataRequest?: UpdateAssetUserMetadataRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Asset>>;
};
/**
...
export declare class BlockchainsAssetsApi extends BaseAPI {
     ...
     */
    getAsset(requestParameters: BlockchainsAssetsApiGetAssetRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<Asset>>;
    /**
     * Returns an blockchain by ID or legacyID.
     * @summary Get an blockchain
     * @param {BlockchainsAssetsApiGetBlockchainRequest} requestParameters Request parameters.
     ...
     * @memberof BlockchainsAssetsApi
     */
    getBlockchain(requestParameters: BlockchainsAssetsApiGetBlockchainRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<BlockchainResponse>>;
    /**
     * Legacy Endpoint – Retrieves all assets supported by Fireblocks in your workspace without extended information.</br> **Note**:    - This endpoint will remain available for the foreseeable future and is not deprecated.</br>   - The `listAssets` endpoint provides more detailed asset information and improved performance.</br>   - We recommend transitioning to the `listAssets` endpoint for better results.
     * @summary List all asset types supported by Fireblocks - legacy endpoint
     * @param {*} [options] Override http request option.
     ...
     * @memberof BlockchainsAssetsApi
     */
    listAssets(requestParameters?: BlockchainsAssetsApiListAssetsRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<ListAssetsResponse>>;
    /**
     * Returns all blockchains supported by Fireblocks.
     * @summary List blockchains
     * @param {BlockchainsAssetsApiListBlockchainsRequest} requestParameters Request parameters.
     ...
     * @memberof BlockchainsAssetsApi
     */
    listBlockchains(requestParameters?: BlockchainsAssetsApiListBlockchainsRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<ListBlockchainsResponse>>;
    /**
     * Register a new asset to a workspace and return the newly created asset\'s details. Currently supported chains are: - EVM based chains - Stellar - Algorand - TRON - NEAR - Solana
     * @summary Register an asset
     * @param {BlockchainsAssetsApiRegisterNewAssetRequest} requestParameters Request parameters.
     ...
     * @memberof BlockchainsAssetsApi
     */
    updateAssetUserMetadata(requestParameters: BlockchainsAssetsApiUpdateAssetUserMetadataRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<Asset>>;
}
