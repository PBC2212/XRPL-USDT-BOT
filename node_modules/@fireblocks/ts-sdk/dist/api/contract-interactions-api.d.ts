...
export declare const ContractInteractionsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    decodeContractData: (contractDataDecodeRequest: ContractDataDecodeRequest, contractAddress: string, baseAssetId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getTransactionReceipt: (baseAssetId: string, txHash: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const ContractInteractionsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    decodeContractData(contractDataDecodeRequest: ContractDataDecodeRequest, contractAddress: string, baseAssetId: string, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ContractDataDecodedResponse>>;
    /**
     * Return deployed contract\'s ABI by blockchain native asset id and contract address
     * @summary Return deployed contract\'s ABI
     * @param {string} contractAddress The contract\&#39;s onchain address
     ...
     * @throws {RequiredError}
     */
    getTransactionReceipt(baseAssetId: string, txHash: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TransactionReceiptResponse>>;
    /**
     * Call a read function on a deployed contract by blockchain native asset id and contract address
     * @summary Call a read function on a deployed contract
     * @param {ReadCallFunctionDto} readCallFunctionDto
...
export declare class ContractInteractionsApi extends BaseAPI {
     ...
     */
    decodeContractData(requestParameters: ContractInteractionsApiDecodeContractDataRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<ContractDataDecodedResponse>>;
    /**
     * Return deployed contract\'s ABI by blockchain native asset id and contract address
     * @summary Return deployed contract\'s ABI
     * @param {ContractInteractionsApiGetDeployedContractAbiRequest} requestParameters Request parameters.
     ...
     * @memberof ContractInteractionsApi
     */
    getTransactionReceipt(requestParameters: ContractInteractionsApiGetTransactionReceiptRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<TransactionReceiptResponse>>;
    /**
     * Call a read function on a deployed contract by blockchain native asset id and contract address
     * @summary Call a read function on a deployed contract
     * @param {ContractInteractionsApiReadCallFunctionRequest} requestParameters Request parameters.
