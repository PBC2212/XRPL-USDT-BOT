...
export declare const VaultsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    attachTagsToVaultAccounts: (vaultAccountsTagAttachmentsRequest: VaultAccountsTagAttachmentsRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    createMultipleDepositAddresses: (createMultipleDepositAddressesRequest: CreateMultipleDepositAddressesRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    detachTagsFromVaultAccounts: (vaultAccountsTagAttachmentsRequest: VaultAccountsTagAttachmentsRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getCreateMultipleDepositAddressesJobStatus: (jobId: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getCreateMultipleVaultAccountsJobStatus: (jobId: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    getPagedVaultAccounts: (namePrefix?: string, nameSuffix?: string, minAmountThreshold?: number, assetId?: string, orderBy?: GetPagedVaultAccountsOrderByEnum, before?: string, after?: string, limit?: number, tagIds?: Array<string>, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const VaultsApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    attachTagsToVaultAccounts(vaultAccountsTagAttachmentsRequest: VaultAccountsTagAttachmentsRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Converts an existing segwit address to the legacy format.
     * @summary Convert a segwit address to legacy format
     * @param {string} vaultAccountId The ID of the vault account
     ...
     * @throws {RequiredError}
     */
    createMultipleDepositAddresses(createMultipleDepositAddressesRequest: CreateMultipleDepositAddressesRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JobCreated>>;
    /**
     * Creates a new vault account with the requested name.
     * @summary Create a new vault account
     * @param {CreateVaultAccountRequest} createVaultAccountRequest
     ...
     * @throws {RequiredError}
     */
    detachTagsFromVaultAccounts(vaultAccountsTagAttachmentsRequest: VaultAccountsTagAttachmentsRequest, idempotencyKey?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
    /**
     * Gets all asset wallets at all of the vault accounts in your workspace. An asset wallet is an asset at a vault account. This method allows fast traversal of all account balances.
     * @summary List asset wallets (Paginated)
     * @param {number} [totalAmountLargerThan] When specified, only asset wallets with total balance larger than this amount are returned.
     ...
     * @throws {RequiredError}
     */
    getCreateMultipleDepositAddressesJobStatus(jobId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateMultipleDepositAddressesJobStatus>>;
    /**
     * Returns the status of bulk creation of new vault accounts job and the result or error Endpoint Permission: Admin, Non-Signing Admin, Signer, Approver, Editor, Viewer.
     * @summary Get job status of bulk creation of new vault accounts
     * @param {string} jobId The ID of the job to create addresses
     ...
     * @throws {RequiredError}
     */
    getCreateMultipleVaultAccountsJobStatus(jobId: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreateMultipleVaultAccountsJobStatus>>;
    /**
     * Get the maximum amount of a particular asset that can be spent in a single transaction from a specified vault account (UTXO assets only, with a limitation on number of inputs embedded). Send several transactions if you want to spend more than the maximum spendable amount.
     * @summary Get the maximum spendable amount in a single transaction.
     * @param {string} vaultAccountId The ID of the vault account, or \&#39;default\&#39; for the default vault account
...
export declare class VaultsApi extends BaseAPI {
     ...
     * @memberof VaultsApi
     */
    attachTagsToVaultAccounts(requestParameters: VaultsApiAttachTagsToVaultAccountsRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<void>>;
    /**
     * Converts an existing segwit address to the legacy format.
     * @summary Convert a segwit address to legacy format
     * @param {VaultsApiCreateLegacyAddressRequest} requestParameters Request parameters.
     ...
     * @memberof VaultsApi
     */
    createMultipleDepositAddresses(requestParameters: VaultsApiCreateMultipleDepositAddressesRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<JobCreated>>;
    /**
     * Creates a new vault account with the requested name.
     * @summary Create a new vault account
     * @param {VaultsApiCreateVaultAccountRequest} requestParameters Request parameters.
     ...
     * @memberof VaultsApi
     */
    detachTagsFromVaultAccounts(requestParameters: VaultsApiDetachTagsFromVaultAccountsRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<void>>;
    /**
     * Gets all asset wallets at all of the vault accounts in your workspace. An asset wallet is an asset at a vault account. This method allows fast traversal of all account balances.
     * @summary List asset wallets (Paginated)
     * @param {VaultsApiGetAssetWalletsRequest} requestParameters Request parameters.
     ...
     * @memberof VaultsApi
     */
    getCreateMultipleDepositAddressesJobStatus(requestParameters: VaultsApiGetCreateMultipleDepositAddressesJobStatusRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<CreateMultipleDepositAddressesJobStatus>>;
    /**
     * Returns the status of bulk creation of new vault accounts job and the result or error Endpoint Permission: Admin, Non-Signing Admin, Signer, Approver, Editor, Viewer.
     * @summary Get job status of bulk creation of new vault accounts
     * @param {VaultsApiGetCreateMultipleVaultAccountsJobStatusRequest} requestParameters Request parameters.
     ...
     * @memberof VaultsApi
     */
    getCreateMultipleVaultAccountsJobStatus(requestParameters: VaultsApiGetCreateMultipleVaultAccountsJobStatusRequest): Promise<import("../response/fireblocksResponse").FireblocksResponse<CreateMultipleVaultAccountsJobStatus>>;
    /**
     * Get the maximum amount of a particular asset that can be spent in a single transaction from a specified vault account (UTXO assets only, with a limitation on number of inputs embedded). Send several transactions if you want to spend more than the maximum spendable amount.
     * @summary Get the maximum spendable amount in a single transaction.
     * @param {VaultsApiGetMaxSpendableAmountRequest} requestParameters Request parameters.
