...
var VaultsApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        attachTagsToVaultAccounts: function (vaultAccountsTagAttachmentsRequest, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, common_1.assertParamExists)('attachTagsToVaultAccounts', 'vaultAccountsTagAttachmentsRequest', vaultAccountsTagAttachmentsRequest);
                    localVarPath = "/vault/accounts/attached_tags/attach";
                    localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
                    }
                    ...
                    headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                    localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(vaultAccountsTagAttachmentsRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
                            url: (0, common_1.toPathString)(localVarUrlObj),
                            options: localVarRequestOptions,
                        }];
         ...
         * @throws {RequiredError}
         */
        createMultipleDepositAddresses: function (createMultipleDepositAddressesRequest, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, common_1.assertParamExists)('createMultipleDepositAddresses', 'createMultipleDepositAddressesRequest', createMultipleDepositAddressesRequest);
                    localVarPath = "/vault/accounts/addresses/bulk";
                    localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
                    }
                    ...
                    headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
                    localVarRequestOptions.headers = __assign(__assign(__assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(createMultipleDepositAddressesRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
                            url: (0, common_1.toPathString)(localVarUrlObj),
                            options: localVarRequestOptions,
                        }];
         ...
         * @throws {RequiredError}
         */
        detachTagsFromVaultAccounts: function (vaultAccountsTagAttachmentsRequest, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, common_1.assertParamExists)('detachTagsFromVaultAccounts', 'vaultAccountsTagAttachmentsRequest', vaultAccountsTagAttachmentsRequest);
                    localVarPath = "/vault/accounts/attached_tags/detach";
                    localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
                    }
         ...
         * @throws {RequiredError}
         */
        getCreateMultipleDepositAddressesJobStatus: function (jobId, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, validation_utils_1.assertParamExistsAndNotEmpty)('getCreateMultipleDepositAddressesJobStatus', 'jobId', jobId);
                    localVarPath = "/vault/accounts/addresses/bulk/{jobId}"
         ...
         * @throws {RequiredError}
         */
        getCreateMultipleVaultAccountsJobStatus: function (jobId, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, validation_utils_1.assertParamExistsAndNotEmpty)('getCreateMultipleVaultAccountsJobStatus', 'jobId', jobId);
                    localVarPath = "/vault/accounts/bulk/{jobId}"
                        .replace("{".concat("jobId", "}"), encodeURIComponent(String(jobId)));
                    localVarUrlObj = new url_1.URL(localVarPath, common_1.DUMMY_BASE_URL);
                    if (configuration) {
                        baseOptions = configuration.baseOptions;
         ...
         * @throws {RequiredError}
         */
        getPagedVaultAccounts: function (namePrefix, nameSuffix, minAmountThreshold, assetId, orderBy, before, after, limit, tagIds, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
    ...
    return {
        ...
        attachTagsToVaultAccounts: function (vaultAccountsTagAttachmentsRequest, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.attachTagsToVaultAccounts(vaultAccountsTagAttachmentsRequest, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['VaultsApi.attachTagsToVaultAccounts']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
        ...
        createMultipleDepositAddresses: function (createMultipleDepositAddressesRequest, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.createMultipleDepositAddresses(createMultipleDepositAddressesRequest, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['VaultsApi.createMultipleDepositAddresses']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
        ...
        detachTagsFromVaultAccounts: function (vaultAccountsTagAttachmentsRequest, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.detachTagsFromVaultAccounts(vaultAccountsTagAttachmentsRequest, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['VaultsApi.detachTagsFromVaultAccounts']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
        ...
        getCreateMultipleDepositAddressesJobStatus: function (jobId, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.getCreateMultipleDepositAddressesJobStatus(jobId, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['VaultsApi.getCreateMultipleDepositAddressesJobStatus']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
        ...
        getCreateMultipleVaultAccountsJobStatus: function (jobId, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.getCreateMultipleVaultAccountsJobStatus(jobId, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['VaultsApi.getCreateMultipleVaultAccountsJobStatus']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
        ...
        getPagedVaultAccounts: function (namePrefix, nameSuffix, minAmountThreshold, assetId, orderBy, before, after, limit, tagIds, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.getPagedVaultAccounts(namePrefix, nameSuffix, minAmountThreshold, assetId, orderBy, before, after, limit, tagIds, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
...
var VaultsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        attachTagsToVaultAccounts: function (requestParameters, options) {
            return localVarFp.attachTagsToVaultAccounts(requestParameters.vaultAccountsTagAttachmentsRequest, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Converts an existing segwit address to the legacy format.
         * @summary Convert a segwit address to legacy format
         ...
         * @throws {RequiredError}
         */
        createMultipleDepositAddresses: function (requestParameters, options) {
            return localVarFp.createMultipleDepositAddresses(requestParameters.createMultipleDepositAddressesRequest, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Creates a new vault account with the requested name.
         * @summary Create a new vault account
         ...
         * @throws {RequiredError}
         */
        detachTagsFromVaultAccounts: function (requestParameters, options) {
            return localVarFp.detachTagsFromVaultAccounts(requestParameters.vaultAccountsTagAttachmentsRequest, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Gets all asset wallets at all of the vault accounts in your workspace. An asset wallet is an asset at a vault account. This method allows fast traversal of all account balances.
         * @summary List asset wallets (Paginated)
         ...
         * @throws {RequiredError}
         */
        getCreateMultipleDepositAddressesJobStatus: function (requestParameters, options) {
            return localVarFp.getCreateMultipleDepositAddressesJobStatus(requestParameters.jobId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Returns the status of bulk creation of new vault accounts job and the result or error Endpoint Permission: Admin, Non-Signing Admin, Signer, Approver, Editor, Viewer.
         * @summary Get job status of bulk creation of new vault accounts
         ...
         * @throws {RequiredError}
         */
        getCreateMultipleVaultAccountsJobStatus: function (requestParameters, options) {
            return localVarFp.getCreateMultipleVaultAccountsJobStatus(requestParameters.jobId, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Get the maximum amount of a particular asset that can be spent in a single transaction from a specified vault account (UTXO assets only, with a limitation on number of inputs embedded). Send several transactions if you want to spend more than the maximum spendable amount.
         * @summary Get the maximum spendable amount in a single transaction.
...
var VaultsApi = /** @class */ (function (_super) {
     ...
     * @memberof VaultsApi
     */
    VaultsApi.prototype.attachTagsToVaultAccounts = function (requestParameters) {
        var _this = this;
        return (0, exports.VaultsApiFp)(this.configuration).attachTagsToVaultAccounts(requestParameters.vaultAccountsTagAttachmentsRequest, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Converts an existing segwit address to the legacy format.
     * @summary Convert a segwit address to legacy format
     ...
     * @memberof VaultsApi
     */
    VaultsApi.prototype.createMultipleDepositAddresses = function (requestParameters) {
        var _this = this;
        return (0, exports.VaultsApiFp)(this.configuration).createMultipleDepositAddresses(requestParameters.createMultipleDepositAddressesRequest, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Creates a new vault account with the requested name.
     * @summary Create a new vault account
     ...
     * @memberof VaultsApi
     */
    VaultsApi.prototype.detachTagsFromVaultAccounts = function (requestParameters) {
        var _this = this;
        return (0, exports.VaultsApiFp)(this.configuration).detachTagsFromVaultAccounts(requestParameters.vaultAccountsTagAttachmentsRequest, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Gets all asset wallets at all of the vault accounts in your workspace. An asset wallet is an asset at a vault account. This method allows fast traversal of all account balances.
     * @summary List asset wallets (Paginated)
     ...
     * @memberof VaultsApi
     */
    VaultsApi.prototype.getCreateMultipleDepositAddressesJobStatus = function (requestParameters) {
        var _this = this;
        return (0, exports.VaultsApiFp)(this.configuration).getCreateMultipleDepositAddressesJobStatus(requestParameters.jobId).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Returns the status of bulk creation of new vault accounts job and the result or error Endpoint Permission: Admin, Non-Signing Admin, Signer, Approver, Editor, Viewer.
     * @summary Get job status of bulk creation of new vault accounts
     ...
     * @memberof VaultsApi
     */
    VaultsApi.prototype.getCreateMultipleVaultAccountsJobStatus = function (requestParameters) {
        var _this = this;
        return (0, exports.VaultsApiFp)(this.configuration).getCreateMultipleVaultAccountsJobStatus(requestParameters.jobId).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Get the maximum amount of a particular asset that can be spent in a single transaction from a specified vault account (UTXO assets only, with a limitation on number of inputs embedded). Send several transactions if you want to spend more than the maximum spendable amount.
     * @summary Get the maximum spendable amount in a single transaction.
    ...
    VaultsApi.prototype.getPagedVaultAccounts = function (requestParameters) {
        var _this = this;
        if (requestParameters === void 0) { requestParameters = {}; }
        return (0, exports.VaultsApiFp)(this.configuration).getPagedVaultAccounts(requestParameters.namePrefix, requestParameters.nameSuffix, requestParameters.minAmountThreshold, requestParameters.assetId, requestParameters.orderBy, requestParameters.before, requestParameters.after, requestParameters.limit, requestParameters.tagIds).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Gets the public key information based on derivation path and signing algorithm.
     * @summary Get the public key information
