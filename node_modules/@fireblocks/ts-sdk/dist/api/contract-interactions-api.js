...
var ContractInteractionsApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        decodeContractData: function (contractDataDecodeRequest, contractAddress, baseAssetId, idempotencyKey, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, common_1.assertParamExists)('decodeContractData', 'contractDataDecodeRequest', contractDataDecodeRequest);
                    (0, validation_utils_1.assertParamExistsAndNotEmpty)('decodeContractData', 'contractAddress', contractAddress);
                    (0, validation_utils_1.assertParamExistsAndNotEmpty)('decodeContractData', 'baseAssetId', baseAssetId);
                    localVarPath = "/contract_interactions/base_asset_id/{baseAssetId}/contract_address/{contractAddress}/decode"
                    ...
                    localVarRequestOptions.data = (0, common_1.serializeDataIfNeeded)(contractDataDecodeRequest, localVarRequestOptions, configuration);
                    return [2 /*return*/, {
         ...
         * @throws {RequiredError}
         */
        getTransactionReceipt: function (baseAssetId, txHash, options) {
            if (options === void 0) { options = {}; }
            return __awaiter(_this, void 0, void 0, function () {
                var localVarPath, localVarUrlObj, baseOptions, localVarRequestOptions, localVarHeaderParameter, localVarQueryParameter, headersFromBaseOptions;
                return __generator(this, function (_a) {
                    (0, validation_utils_1.assertParamExistsAndNotEmpty)('getTransactionReceipt', 'baseAssetId', baseAssetId);
                    (0, validation_utils_1.assertParamExistsAndNotEmpty)('getTransactionReceipt', 'txHash', txHash);
                    localVarPath = "/contract_interactions/base_asset_id/{baseAssetId}/tx_hash/{txHash}/receipt"
                        .replace("{".concat("baseAssetId", "}"), encodeURIComponent(String(baseAssetId)))
    ...
    return {
        ...
        decodeContractData: function (contractDataDecodeRequest, contractAddress, baseAssetId, idempotencyKey, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.decodeContractData(contractDataDecodeRequest, contractAddress, baseAssetId, idempotencyKey, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['ContractInteractionsApi.decodeContractData']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
        ...
        getTransactionReceipt: function (baseAssetId, txHash, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0: return [4 /*yield*/, localVarAxiosParamCreator.getTransactionReceipt(baseAssetId, txHash, options)];
                        case 1:
                            localVarAxiosArgs = _d.sent();
                            index = (_a = configuration === null || configuration === void 0 ? void 0 : configuration.serverIndex) !== null && _a !== void 0 ? _a : 0;
                            operationBasePath = (_c = (_b = base_1.operationServerMap['ContractInteractionsApi.getTransactionReceipt']) === null || _b === void 0 ? void 0 : _b[index]) === null || _c === void 0 ? void 0 : _c.url;
                            return [2 /*return*/, function (axios, basePath) { return (0, common_1.createRequestFunction)(localVarAxiosArgs, axios_1.default, base_1.BASE_PATH, configuration)(axios, operationBasePath || basePath); }];
                    }
                });
            });
...
var ContractInteractionsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        decodeContractData: function (requestParameters, options) {
            return localVarFp.decodeContractData(requestParameters.contractDataDecodeRequest, requestParameters.contractAddress, requestParameters.baseAssetId, requestParameters.idempotencyKey, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Return deployed contract\'s ABI by blockchain native asset id and contract address
         * @summary Return deployed contract\'s ABI
         ...
         * @throws {RequiredError}
         */
        getTransactionReceipt: function (requestParameters, options) {
            return localVarFp.getTransactionReceipt(requestParameters.baseAssetId, requestParameters.txHash, options).then(function (request) { return request(axios, basePath); });
        },
        /**
         * Call a read function on a deployed contract by blockchain native asset id and contract address
         * @summary Call a read function on a deployed contract
...
var ContractInteractionsApi = /** @class */ (function (_super) {
     ...
     */
    ContractInteractionsApi.prototype.decodeContractData = function (requestParameters) {
        var _this = this;
        return (0, exports.ContractInteractionsApiFp)(this.configuration).decodeContractData(requestParameters.contractDataDecodeRequest, requestParameters.contractAddress, requestParameters.baseAssetId, requestParameters.idempotencyKey).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Return deployed contract\'s ABI by blockchain native asset id and contract address
     * @summary Return deployed contract\'s ABI
     ...
     * @memberof ContractInteractionsApi
     */
    ContractInteractionsApi.prototype.getTransactionReceipt = function (requestParameters) {
        var _this = this;
        return (0, exports.ContractInteractionsApiFp)(this.configuration).getTransactionReceipt(requestParameters.baseAssetId, requestParameters.txHash).then(function (request) { return request(_this.axios, _this.basePath); }).then(fireblocksResponse_1.convertToFireblocksResponse);
    };
    /**
     * Call a read function on a deployed contract by blockchain native asset id and contract address
     * @summary Call a read function on a deployed contract
